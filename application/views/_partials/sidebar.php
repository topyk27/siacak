<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item has-treeview">
      <a href="#" class="nav-link" id="sidebar_kk">
        <i class="nav-icon fas fa-book"></i>
        <p>Kartu Keluarga<i class="fas fa-angle-left right"></i></p>
      </a>
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="<?php echo base_url('kk/belum') ?>" class="nav-link" id="sidebar_kk_belum">
            <i class="nav-icon far fa-circle"></i>
            <p>Belum Terbit</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo base_url('kk/sudah') ?>" class="nav-link" id="sidebar_kk_sudah">
            <i class="nav-icon far fa-circle"></i>
            <p>Sudah Terbit</p>
          </a>
        </li>
