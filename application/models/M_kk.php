...
class M_kk extends CI_Model
{
    public function belum()
    {
        ...
        // end coba sesuai MOU
        // coba ambil benar benar data pihaknya belum fix
        $statement = "SELECT DISTINCT a.perkara_id, b.telepon AS p_telp, c.telepon AS t_telp, a.nomor_perkara, a.tanggal_putusan, b.nama AS nama_p, b.nomor_indentitas AS nik_p, b.tanggal_lahir AS tanggal_lahir_p, b.agama_id AS agama_id_p, b.pekerjaan AS pekerjaan_p, b.alamat AS alamat_p, c.nama AS nama_t, c.nomor_indentitas AS nik_t, c.tanggal_lahir AS tanggal_lahir_t, c.agama_id AS agama_id_t, c.pekerjaan AS pekerjaan_t, c.alamat AS alamat_t, d.nomor_akta_cerai, d.tgl_akta_cerai, a.amar_putusan, a.tgl_nikah, a.no_kutipan_akta_nikah, a.kua_tempat_nikah, a.jenis_perkara_id
        FROM v_perkara a, pihak b, pihak c, perkara_akta_cerai d, perkara_pihak1 p1, perkara_pihak2 p2
        WHERE a.perkara_id = p1.perkara_id
        AND p1.pihak_id = b.id
        AND a.perkara_id = p2.perkara_id
        AND p2.pihak_id = c.id
        AND a.perkara_id = d.perkara_id
        AND d.nomor_akta_cerai != ''
        AND YEAR(d.tgl_akta_cerai) = '$mulai_tahun'
        ORDER BY d.tgl_akta_cerai ASC";
        // jenis perkara id 347=cg || 346=ct
        // 
